/* 
 *
 * This file is a port from "c_rput.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: CRPut.java			Author: N. Graham
 *
 */
//package onesided;
...
public class CRPut
{
  public static void main (String args[]) throws MPIException
  {
    ...
    */
    ...
    for (int i = 0; i < size; ++i) {
      Request req = win.rPut(slice(putVals, i), 1, MPI.INT, i, rank, 1, MPI.INT); //win example
      req.waitFor();
    }
    win.fence(0);
