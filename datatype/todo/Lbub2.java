/* 
 *
 * This file is a port from "lbub2.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: Lbub2.java			Author: S. Gross
 *
 */
...
public class Lbub2
{
  ...
  public static void main (String args[]) throws MPIException
  {
    ...
    aod3[2] = 0;
    aob3[2] = 1;
    newtype2 = Datatype.createStruct(aob3, aod3, aot3);
    newtype2.commit();
    ...
    if (DB_TALK != 0) {
      System.out.printf("Talking:\n" +
			"Should be: Extent = 36, lb = 65, ub = 101.\n" +
			"Is:        Extent = %d, lb = %d, ub = %d.\n",
			extent, lb, ub);
    }
