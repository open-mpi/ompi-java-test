/* 
 *
 * This file is a port from "zero3.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: Zero3.java			Author: S. Gross
 *
 */
...
public class Zero3
{
  ...
  public static void main (String args[]) throws MPIException
  {
    ...
    int ii[] = new int [1];
    //    MPI_Aint aod[10];
    /* Java uses "length" to determine the number of elements in
     * an array, so that we need an arrays with three elements.
     */
    int aob[] = new int[3],
        aod[] = new int[3];
    ...
    aob[2] = 0;
    aod[2] = 6;
    newtype = Datatype.createStruct(aob, aod, aot);
    newtype.commit();
