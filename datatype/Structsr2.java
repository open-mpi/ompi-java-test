/* 
 *
 * This file is a port from "structsr2.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: Structsr2.java			Author: S. Gross
 *
 */
...
public class Structsr2
{
  ...
  public static void main (String args[]) throws MPIException
  {
    ...
    //    MPI_Aint extent;
    int myrank, me, numtasks, size, extent,
	tmp, tmp3, error = 0;
	...
	OmpitestError.ompitestError(OmpitestError.getFileName(),
       ...
       * to debug .... 
       * System.out.printf("idx %#4d  original %#4d  packval %#4d  " +
       * 		   "unpackval %#4d\n", i, tmp, tmp2, tmp3);
       */
    }
    newtype1.free();
