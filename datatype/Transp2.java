/* 
 *
 * This file is a port from "transp2.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: Transp2.java			Author: S. Gross
 *
 */

import mpi.*;

public class Transp2
{
  public static void main (String args[]) throws MPIException
  {
    ...
    type_oz = Datatype.createHIndexed(aob, aod, MPI.INT);
    ...
    type_oy = Datatype.createHIndexed(aob, aod, type_oz);
    ...
    type_ox = Datatype.createHIndexed(aob, aod, type_oy); 
    type_ox.commit();
    ...
    type_ic = Datatype.createHIndexed(aob, aod, MPI.INT);
    ...
    type_ib = Datatype.createHIndexed(aob, aod, type_ic);
    ...
    type_ia = Datatype.createHIndexed(aob, aod, type_ib); 
    type_ia.commit();
