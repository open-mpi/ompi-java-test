/* 
 *
 * This file is a port from "send2.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: Send2.java			Author: S. Gross
 *
 */
...
public class Send2
{
  ...
  public static void main (String args[]) throws MPIException
  {
	...
	recv_right.put(i, (char)0);
      ...
      req[1] = comm2.iSend(send_right, len, MPI.CHAR, right, 222);
      req[2] = comm2.iRecv(recv_left, len, MPI.CHAR, left, 222);
