 ...
 *   java_outputFilename_msgSize_intValues_cputime.dat,
 *   java_outputFilename_msgSize_intValues_elapsedtime.dat,
 ...
 *
 * Usage:
 *   mpiexec -np <number of processes> java BcastPerformanceNumProc
 *	[message size] [output filename]
 *
 *
 * File: BcastPerformanceNumProc.java	Author: S. Gross
 * Date: 20.05.2013
 *
 */
...
public class BcastPerformanceNumProc
{
  ...
  public static void main (String args[]) throws MPIException
  {
    ...
    if (mytid == 0)
    {
      ...
      filename_cpu = filename_cpu + "_" + String.valueOf(msgSize[0]) +
	"_intValues";
	...
	fp_elapsed.write (ntasks + "  " + elapsedTime + "\n");
        fp_elapsed.close ();
      }
      catch (IOException ex)
      {
  ...
  {
    String className = new BcastPerformanceNumProc().getClass().getName();
