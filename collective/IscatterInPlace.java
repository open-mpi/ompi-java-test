/* 
 *
 * This file is a port from "iscatter_in_place.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: IscatterInPlace.java		Author: S. Gross
 *
 */
...
public class IscatterInPlace
{
  ...
  public static void main (String args[]) throws MPIException
  {
	...
	request = MPI.COMM_WORLD.iScatter(out, j, MPI.INT, root);
      } else {
