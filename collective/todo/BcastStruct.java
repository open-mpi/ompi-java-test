/* 
 *
 * This file is a port from "bcast_struct.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: BcastStruct.java		Author: S. Gross
 *
 */
...
public class BcastStruct
{
  ...
  public static void main (String args[]) throws MPIException
  {
    ...
    MPI.COMM_WORLD.bcast(MPI.BOTTOM, 1, newtype, 0);
    if (iDaData.getI() != 2 ||
	...
	/* Broadcast */
	//	MPI_Bcast(bar, i, newtype, root, MPI.COMM_WORLD);
	MPI.COMM_WORLD.bcast(barBuf, i, newtype, root);
	...
	if (i > MAX_SIZE) {
	  ...
	  MPI.COMM_WORLD.bcast(done_flag, 1, MPI.BOOLEAN, 0);
