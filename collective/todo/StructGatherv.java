/* 
 *
 * This file is a port from "struct_gatherv.c" from the "ompi-ibm-10.0"
 * regression test package. The formatting of the code is
 * mainly the same as in the original file.
 *
 *
 * File: StructGatherv.java		Author: S. Gross
 *
 */

import mpi.*;

public class StructGatherv
{
  ...
  public static void main (String args[]) throws MPIException
  {
    ...
    /* gather the counts */
    MPI.COMM_WORLD.gather(num, 1, MPI.INT, rcounts, 1, MPI.INT, root);
    ...
    /* gatherv */
    MPI.COMM_WORLD.gatherv(sendarray, num[0], stype, rbuf, rcounts,
			   displs, MPI.INT, root);
